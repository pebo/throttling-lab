...
public class HzThrottlingServiceNoLock implements ThrottlingService {

	private static final Logger logger = LoggerFactory
			.getLogger(HzThrottlingServiceNoLock.class);

	private HazelcastInstance hazelcastInstance;

	public HzThrottlingServiceNoLock(HazelcastInstance hazelcastInstance) {
